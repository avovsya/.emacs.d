;; Skewer mode
;; Run `M-x run-skewer` to attach browser to Emacs
;; `skewer-repl` - REPL to the browser
...
;;   (define-key js2-mode-map (kbd open) (lambda (js2r--self-insert-wrapping open close)))
